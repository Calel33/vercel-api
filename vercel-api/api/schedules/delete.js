...
// Handles deletion of scheduled prompts
const { hashKey, deleteSchedule } = require('../../lib/scheduleManager.js');
...
function handler(req, res) {
    ...
    try {
        ...
        // Delete the schedule
        const result = deleteSchedule(scheduleId, hashedKey);
